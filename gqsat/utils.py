...
def build_argparser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=128,
        help="Batch size for the learning step"
    )
    parser.add_argument(
        "--eps-init",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Frames to stack for the input"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Step every k-th frame"
    )
    parser.add_argument(
        "--loss",
        default="mse",
        help="Loss to use: mse|huber")
    parser.add_argument(
        "--save-freq",
        default=100000,
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of hidden layers for all MLPs."
    )
    parser.add_argument(
        "--hidden_size",
        type=int,
